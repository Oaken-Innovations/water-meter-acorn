...
}`},function(module,exports,__webpack_require__){"use strict";const handshake=__webpack_require__(80),deferred=__webpack_require__(216);class State{constructor(id,key,timeout,cb){"function"==typeof timeout&&(cb=timeout,timeout=void 0),this.setup(),this.id.local=id,this.key.local=key,this.timeout=timeout||6e4,cb=cb||(()=>{}),this.secure=deferred.duplex(),this.stream=handshake({timeout:this.timeout},cb),this.shake=this.stream.handshake,delete this.stream.handshake}setup(){this.id={local:null,remote:null},this.key={local:null,remote:null},this.shake=null,this.cleanSecrets()}cleanSecrets(){this.shared={},this.ephemeralKey={local:null,remote:null},this.proposal={in:null,out:null},this.proposalEncoded={in:null,out:null},this.protocols={local:null,remote:null},this.exchange={in:null,out:null}}}module.exports=State},function(module,exports){},function(module,exports,__webpack_require__){module.exports=__webpack_require__(92)}]);