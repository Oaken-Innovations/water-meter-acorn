...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(60).Buffer, __webpack_require__(87)))
...
var Reader = __webpack_require__(308);
var Buffer = __webpack_require__(115).Buffer;
var pushable = __webpack_require__(307);
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(11)(proto, TO_PRIMITIVE, __webpack_require__(125));
...
"use strict";
'use strict'
var State = __webpack_require__(309)
...
module.exports = function (timeout) {
  ...
  reader.read = function (len, timeout, cb) {
    ...
    if(isFunction(cb)) {
      console.log('pushing to queue', len)
      ...
      return function (abort, cb) {
        ...
        if(reading || state.has(1)) {
          ...
          console.log('pushing to queue - stream')
